...
const MyAdvertisementsWrapper = styled.div`
...
const MyAdvertisements = () => {
    ...
    const handleAdvertisementClick = (advertisement) => {
        navigate('/my_advertisement', {state: {advertisement}});
    };

    return (
        <MyAdvertisementsWrapper>
            <Header>Мої оголошення</Header>
            ...
            <AdvertisementRow>
                ...
                <AdvertisementColumn>Умова доствки</AdvertisementColumn>
            </AdvertisementRow>
